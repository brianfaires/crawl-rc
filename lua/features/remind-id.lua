...
Author: buehler
Dependencies: CONFIG, BRC.COLORS, EMOJI, BRC.util.color, iter, persistent_data
--]]
...
local IDENTIFY_MSG = BRC.util.color(BRC.COLORS.magenta, " You have something to identify. ")
