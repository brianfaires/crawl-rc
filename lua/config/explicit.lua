...
brc_config_explicit = {
  ...
  ["pickup-alert"] = {
    ...
    Alert = {
      armour_sensitivity = 1.0, -- Adjust all alerts; 0 to disable all (typical range 0.5-2.0)
      weapon_sensitivity = 1.0, -- Adjust all alerts; 0 to disable all (typical range 0.5-2.0)
      orbs = true,
      staff_resists = true,
      talismans = true,
      first_ranged = true,
